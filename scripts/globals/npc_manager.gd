...
var FailedPC = load("res://scenes/npcs/characters/failedpc.tscn").instantiate() #Do not add him to the list!
var Angel = load("res://scenes/npcs/characters/angel.tscn").instantiate()
...
func start_conversation(filename, dialogue):	
	...
	balloon.start(load("res://dialogue/dialogues/" + filename + ".dialogue"), dialogue)
